...
def load_sprite_sheet(dir1, dir2, width, height, direction=False):
    ...
    for image in images:
        ...
        for i in range(sprite_sheet.get_width() // width):
            ...
            sprites.append(pygame.transform.scale(surface, (width + width * WIDTH_SCALE, height + height * HEIGHT_SCALE)))
...
def get_block(size):
    ...
    return pygame.transform.scale(surface, (size + size * WIDTH_SCALE, size + size * HEIGHT_SCALE))
...
def main(window):
    ...
    fire = Fire(200, HEIGHT - block_size - 57, 16, 32)
    fire.on()
